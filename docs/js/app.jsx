...
*/
var aa=__webpack_require__(0),n=__webpack_require__(5),q=__webpack_require__(12);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));var ba=null,ca={};
...
/* harmony default export */ var navbar = (function (__params = {}) {
  const {
    NavBarContainer
  } = __params;
  return react_default.a.createElement("nav", {
    ...
    href: "home"
  }, "POE\u5546\u5E97\u76E3\u807D"), react_default.a.createElement(NavBarContainer, null)), react_default.a.createElement("div", {
...
// CONCATENATED MODULE: ./pug/navbarcontainer.pug

/* harmony default export */ var navbarcontainer = (function (__params = {}) {
  const {
    Link,
    hrf,
    txt
  ...
  return react_default.a.createElement("ul", {
    ...
    className: "nav-link",
    to: hrf
  }, txt)), react_default.a.createElement("li", {
    className: "nav-item"
  }, react_default.a.createElement(Link, {
    className: "nav-link",
    to: hrf
...
var navbar_NavBar = function NavBar() {
  return navbar.call(navbar_this, navbar_NavBarContainer);
};
...
function (_React$Component) {
  ...
  _createClass(NavBarContainer, [{
    ...
    value: function render() {
      return navbarcontainer.call(this);
    }
  }]);
...
/* harmony default export */ var src_navbar = (navbar_NavBar);
...
var main_App = function App() {
  return react_default.a.createElement("div", null, react_default.a.createElement(src_navbar, null), react_default.a.createElement(Container, null));
}; //const MyComponent = () => {return <nav></nav>};
// 將 <MyComponent /> 元件插入 id 為 app 的 DOM 元素中


react_dom_default.a.render(react_default.a.createElement(react_router_dom_BrowserRouter, null, react_default.a.createElement(main_App, null)), document.getElementById('app'));
console.log('app run');
